# Hi, I'm Gabriela! 👋 💊 🏠 📊
### Pharmacist & Real Estate professional turned Data Analyst — turning domain experience into data insights.
## 👩‍💻 About Me
- 💊 I spent 10 years in **pharmacy** and several years in **real estate** before discovering my passion for data
- 📊 I'm now transitioning into **data analytics**, combining domain expertise with technical skills
...
| [🧹 PharmaMarket_Cleaning](https://github.com/GabrielaY0rdanova/PharmaMarket_Cleaning) | Data cleaning and quality validation project built on the ETL output — fixing encoding artifacts, structural issues, and documenting all findings | SQL Server, T-SQL, Python, pandas |
